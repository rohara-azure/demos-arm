...
if ($runAsAutoLogon -ieq "true") {
    ...
    .\config.cmd --unattended --url $serverUrl --auth PAT --token $PersonalAccessToken --pool $PoolName --agent $AgentName --runasservice --windowslogonaccount $vmAdminUserName --windowslogonpassword $vmAdminPassword
}
